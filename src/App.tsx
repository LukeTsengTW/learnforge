...
export function Application({ auth, createRepository }: { auth: AuthService | null; createRepository: PracticeRepositoryFactory }) {
  return <HashRouter><AuthProvider service={auth}><PracticeBoundary createRepository={createRepository}><AppRoutes /></PracticeBoundary></AuthProvider></HashRouter>
}
